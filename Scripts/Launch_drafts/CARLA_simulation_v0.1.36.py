...
Versioning: v0.1.36 (Custom Font for Notifications)
...
class HUD(object):
    def __init__(self, width, height, args): # Added args to __init__
        ...
        self.custom_notification_font_path = os.path.join(args.carla_root, 'CarlaUE4', 'Content', 'Carla', 'Aeromovedemo.ttf')
    ...
    def notification(self, text, seconds=2.0, text_color=(255,255,255), 
        ...
        if self._use_custom_notification_font:
            ...
            notification_symbol_font = pygame.font.Font(self.custom_notification_font_path, symbol_size) # Changed to use custom font for symbols too
        else:
...
class BlinkingAlert(object):
    ...
    def set_text(self, text, text_color=(255, 255, 255), seconds=2.0, 
        ...
        if self.is_critical_center:
            ...
            self.initial_pos = [(self.dim[0] - box_width) // 2, target_center_y - box_height // 2]
        else:
            self.initial_pos = [(self.dim[0] - box_width) // 2, self.dim[1]] 
...
class CameraManager(object):
    ...
    def _parse_image(weak_self, image):
        ...
        if sensor_type.startswith('sensor.lidar'):
            ...
            lidar_img_size = (self.hud.dim[0], self.dim[1], 3)
