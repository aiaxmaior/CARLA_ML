...
Versioning: v0.1.37 (Fixed HUD.__init__ argument)
...
class HUD(object):
    def __init__(self, width, height, args): # Added args to __init__
        ...
        self.custom_notification_font_path = os.path.join(args.carla_root, 'CarlaUE4', 'Content', 'Carla','Fonts', 'Aeromovedemo.ttf')
