...
Versioning: v0.1.24 (Corrected Notifications)
                ...
                if isinstance(self._control, carla.VehicleControl) and world.player:
                    if event.key == K_q: 
                        ...
                        world.hud.notification('%s Transmission' %
                                            ('Manual' if self._control.gear_mode_manual else 'Automatic')) # Corrected: used _gear_mode_manual instead of _control.manual_gear_shift
