...
Versioning: v0.1.29 (Fixed LaneMarkingType attributes)
...
class HUD(object):
    ...
    def deduct_score(self, points, violation_type="unknown"):
        ...
        self.notification(seconds=3.0 if is_critical else 2.5, 
    ...
    def _on_invasion(weak_self, event):
        ...
        if dot_product_with_occupied_lane < -0.7: # Threshold for "oncoming"
            ...
            for marking in event.crossed_lane_markings:
                # Corrected: Removed non-existent LaneMarkingType attributes
                if marking.type in [carla.LaneMarkingType.Solid, 
                                    carla.LaneMarkingType.DoubleSolid]: # Use DoubleSolid instead of DoubleSolidYellow
