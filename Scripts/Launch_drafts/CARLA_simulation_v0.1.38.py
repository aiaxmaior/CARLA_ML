...
Versioning: v0.1.38 (Fixed BlinkingAlert dim and Font Path)
...
class HUD(object):
    def __init__(self, width, height, args): # Added args to __init__
        ...
        self.custom_notification_font_path = os.path.join(args.carla_root, 'CarlaUE4', 'Content', 'Carla', 'Fonts', 'Aeromovedemo.ttf') # Corrected font path
...
class BlinkingAlert(object):
    ...
    def set_text(self, text, text_color=(255, 255, 255), seconds=2.0, 
        ...
        if self.is_critical_center:
            ...
            self.initial_pos = [(self.screen_dim[0] - box_width) // 2, self.dim[1]] 
