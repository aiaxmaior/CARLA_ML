...
Versioning: v0.1.30 (Fixed LaneMarkingType and HUD Notification Call)
...
class HUD(object):
    ...
    def deduct_score(self, points, violation_type="unknown"):
        ...
        # Fixed: Added 'text' argument to notification call
        self.notification(penalty_message, # Pass the generated message here
